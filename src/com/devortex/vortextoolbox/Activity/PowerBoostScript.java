...
public class PowerBoostScript extends Activity{
	private Context _context = PowerBoostScript.this;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        tvToggleLabel.setText(getString(R.string.pbtweaks_togglelabel));
        TextView tvDescription = (TextView) findViewById(R.id.tvDescription);
        tvDescription.setText(getString(R.string.pbscript_description));
	...
	protected boolean doSwitchTweaks(boolean checked) {
		AlertDialog.Builder builder = new AlertDialog.Builder(_context);
	 	 builder.setMessage(getString(R.string.pbmod_warning) + "\nAre you sure you want to continue?")
	 	        .setCancelable(false)
	 	...
	 	if (getContinue())
	 	{
			...
			if (checked)
			{
				try {
					...
					commandRunner.enableTweaks(_context, pbScripts);
	...
	{
		String checkFile = getResources().getStringArray(R.array.powerboost_scripts)[0];
        File scriptCheck = new File("/system/etc/init.d/" + checkFile);
